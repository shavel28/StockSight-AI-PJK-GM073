...
[![GitHub Repository](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github)](https://github.com/duchessmileena/StockSightCapstone/tree/main)
...
2. 📊 **Dasbor Analitik (Overview):** Visualisasi *Key Performance Indicators* (KPI) dan distribusi data menggunakan grafik yang mulus.
3. 📦 **Manajemen Inventaris:** Tabel data dinamis yang dilengkapi sistem indikator warna (Aman/Stok Rendah/Kritis) untuk *Safety Stock* dan *Reorder Point*.
4. ⚙️ **Data Pipeline Dashboard:** Panel visual untuk memantau proses pembersihan data, deteksi anomali (outlier), dan dampak *event* khusus.
5. 🔮 **Prediksi Masa Depan (Forecasting):** Antarmuka simulasi AI untuk meramalkan grafik penjualan masa depan (H+30), lengkap dengan informasi metrik MAPE dan RMSE.
6. 🎛️ **Simulasi Skenario Bisnis:** Form kontrol pengaturan (*Settings*) untuk menyesuaikan parameter AI secara *real-time* seperti skenario optimis/pesimis dan faktor pertumbuhan pasar.

## 🛠️ Teknologi yang Digunakan
*   **Framework:** React.js
*   **Visualisasi Data:** Chart.js & `react-chartjs-2`
*   **Styling:** Custom CSS3 (Variables, Flexbox, CSS Grid, & Keyframe Animations)
*   **Font Typography:** News Cycle & Newsreader (Google Fonts)
*   **Deployment:** Railway
